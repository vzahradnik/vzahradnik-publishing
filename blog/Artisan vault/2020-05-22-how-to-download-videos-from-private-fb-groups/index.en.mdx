...
I made a detailed walkthrough of youtube-dl in this video:

<div className="Image__Medium">
  <div style="width:100%;height:0;padding-bottom:56%;position:relative;"><iframe class="rumble" width="100%" height="100%" src="https://rumble.com/embed/vnuw49/?pub=piche" style="position:absolute" frameborder="0" allowfullscreen></iframe></div>
  <figcaption>youtube dl - Downloading YouTube videos easily</figcaption>
</div>
